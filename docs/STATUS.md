...
**Qué hace**: Registra quién hizo qué y cuándo en cada tarjeta y tablero.
...
- **Frontend**: (public/index.html)
  ...
  - Se oculta en tarjetas nuevas, aparece al abrir una tarjeta existente
  - `actionLabel(action, details)` convierte eventos a texto en español
...
**Estado**: **100% completo** según spec — todos los eventos planificados implementados.
