...
**Última versión desplegada registrada**: 2.2.0. Release v2.2.1 integrada y autorizada para producción; despliegue en curso. Ver `docs/STATUS.md`.
...
### ⏭️ Próximo
1. **Performance**: completar y registrar el deploy de v2.2.1 a producción. PR #38 ya está integrado; el SHA `0f307f8` pasó 154 pruebas de backend y 62 E2E y fue validado en staging. Version IDs en `docs/STATUS.md`.
