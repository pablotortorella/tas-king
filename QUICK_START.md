...
### ⏭️ Próximo
1. **Sincronización de comentarios, checklists y borrados**: PR #41 desplegado en staging, pendiente de revisión autenticada e integración. Ver `docs/STATUS.md`. La migración **0015 debe aplicarse antes del Worker nuevo** también en producción.
