// Modal de tarjeta: todo lo que pasa con una tarjeta abierta.
//
// Campos, comentarios, historial, adjuntos, checklists, etiquetas y objetivos.
// Es grande porque es una sola cosa: el modal orquesta sus paneles y los paneles
...
// devuelve si el borrado ocurrió, y eso el bus no puede transportarlo.

import { api } from "./core/api.js";
import { emit, on } from "./core/bus.js";
import { LABEL_COLORS, avatarHtml, escapeHtml, relativeTime, shortName } from "./core/dom.js";
import { estado } from "./core/state.js";
import { actionLabel, applySavedCard, loadCards, withCardMutation } from "./board.js";
import { archiveCard, deleteCard } from "./archive.js";
...
export function populateColumnSelect() {
...
export function openModal(id, defaultCol) {
...
export function renderCardGoals() {
