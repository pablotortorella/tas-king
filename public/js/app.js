...
(function () {
  ...
  // ---------- Paleta de color por tablero (#10) ----------
  const PALETTES = [
  ...
  function applyBoardPalette(theme) {
    const palette = PALETTES.some(p => p.key === theme) ? theme : "candy_pop";
    document.documentElement.setAttribute("data-palette", palette);
  }

  // ---------- Pulso WIP: "Dejar de empezar y empezar a terminar" ----------
  // Recorre las columnas en curso (ni la primera, ni las de cierre) de derecha a
  // izquierda con un pulso sutil, para invitar a terminar antes de empezar algo nuevo.
  ...
  function runWipPulseSequence({ alwaysShowMessage = false } = {}) {
